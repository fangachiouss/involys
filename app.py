...
def run(): 
    ...
    if(add_selectbox=='online'):
        ...
        input_dict={"Type dépense":type_depense,"Montant Dépense":montant_depense,"Service demandeur":Service_demandeur,"Délai exécution":delai_execution,"Fournisseur":Fournisseur,"Date validation facture":date1,"Montant facture HT":Montant_facture_HT}
